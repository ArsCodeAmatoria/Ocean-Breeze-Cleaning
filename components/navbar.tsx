      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link href="#benefits" className="text-white/80 hover:text-cyan-400 transition duration-300">
              Services
            </Link>
            <Link href="#data-analysis" className="text-white/80 hover:text-cyan-400 transition duration-300">
              The Science
            </Link>
