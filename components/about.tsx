  ...
  return (
    <section id="about" className="py-20 bg-gray-900 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="absolute top-20 right-0 w-64 h-64 bg-blue-900/20 rounded-full blur-3xl opacity-60 -z-10"></div>
        <div className="absolute bottom-20 left-0 w-80 h-80 bg-cyan-900/20 rounded-full blur-3xl opacity-60 -z-10"></div>
              ...
              <div className="relative mx-auto max-w-sm">
                ...
                <div className="relative z-10 rounded-xl overflow-hidden shadow-2xl">
                  ...
                  <motion.div 
                    ...
                    viewport={{ once: true }}
                    className="absolute -bottom-5 -right-5 bg-gray-800 rounded-full shadow-lg p-3"
                  >
                  ...
                  <motion.div 
                    ...
                    viewport={{ once: true }}
                    className="absolute -top-4 -left-4 bg-gray-800 rounded-full shadow-lg p-2"
                  >
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="absolute -bottom-6 -left-2 bg-gray-800 px-4 py-2 rounded-lg shadow-lg"
                >
                  <p className="text-sm font-semibold text-white">
                    <span className="text-cyan-400">10+ </span>Years Experience
                  </p>
                </motion.div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="grid md:grid-cols-3 gap-4 mb-8">
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="bg-blue-900/20 p-5 rounded-xl"
                >
                  <div className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center mb-3 shadow-md">
                    <Award className="h-6 w-6 text-blue-400" />
                  </div>
                  <h3 className="font-semibold text-white mb-2">Health-Focused Approach</h3>
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="bg-cyan-900/20 p-5 rounded-xl"
                >
                  <div className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center mb-3 shadow-md">
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="bg-teal-900/20 p-5 rounded-xl"
                >
                  <div className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center mb-3 shadow-md">
                    <TrendingUp className="h-6 w-6 text-teal-400" />
                  </div>
                  <h3 className="font-semibold text-white mb-2">Continuous Growth</h3>
                  <p className="text-sm text-gray-300">
              ...
              <div className="flex justify-center md:justify-start">
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="group relative overflow-hidden px-8 py-4 bg-gray-800 border-2 border-cyan-500 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
                >
