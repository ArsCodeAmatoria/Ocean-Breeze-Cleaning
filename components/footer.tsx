...
const Footer = () => {
  return (
    <footer id="contact" className="bg-gray-900 text-white pt-16 pb-8 w-full h-full flex flex-col justify-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-white hover:text-cyan-400 transition bg-blue-900/20 p-2 rounded-full">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold mb-4 border-b border-blue-700/30 pb-2 text-white">Quick Links</h3>
            <ul className="space-y-2">
              <li>
                <Link href="#microbes" className="text-gray-300 hover:text-cyan-400 transition flex items-center">
                  <span className="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>
                  The Science
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-gray-300 hover:text-cyan-400 transition flex items-center">
                  <span className="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>
                  About Us
                </Link>
              </li>
              <li>
                <Link href="#contact" className="text-gray-300 hover:text-cyan-400 transition flex items-center">
                  <span className="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>
                  Contact
                </Link>
              </li>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-lg font-semibold mb-4 border-b border-blue-700/30 pb-2 text-white">Contact Us</h3>
            <div className="space-y-4">
              <div className="flex items-start">
                <MapPin className="h-5 w-5 text-cyan-500 mt-1 mr-3" />
                <p className="text-gray-300">123 Breeze Way, Ocean City, FL 33123</p>
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                <p className="text-gray-300">info@breezify.me</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Newsletter */}
        <div className="border-t border-b border-blue-700/20 py-8 mb-8">
          <div className="md:flex justify-between items-center">
            <div className="mb-4 md:mb-0">
              <h3 className="text-lg font-semibold mb-1 text-white">Subscribe to Our Newsletter</h3>
              <p className="text-gray-300">Stay updated with cleaning tips and health research</p>
            </div>
            <div className="flex">
              <input 
                type="email" 
                placeholder="Your email address" 
                className="px-4 py-2 bg-gray-800/80 border border-blue-700/30 text-white rounded-l-md focus:outline-none focus:ring-2 focus:ring-cyan-500/50 placeholder:text-gray-500"
              />
